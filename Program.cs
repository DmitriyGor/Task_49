...
m = 3, n = 5.      
например, изначально массив выглядит так:     новый массив будет выглядеть так:
1  4  8 19  2                                 1  4  8 19  2                                                                    
5 -2 33 -2  4                                 5 -2 33 -2  4
77 3  8  1  3                                 77 3  64  1  9
*/
// Двумерный массив
...
// Метод, который ищет элементы, у которых оба индекса четные, и заменяет их на их квадраты
